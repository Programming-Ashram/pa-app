import Car from "../export/mostsearchcar.js";
...
let allSearchedCars = [Kia, Skoda, Mahindra, Fortuner];

let allsearchcararea = document.getElementById('allsearchcararea');

allSearchedCars.forEach(car => {
    allsearchcararea.innerHTML +=`
        <div class='col-md-3'>
