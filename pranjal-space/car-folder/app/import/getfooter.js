...
document.querySelector('footer').innerHTML+=`
		<div class="container">
		   <div class="row">
			  <div class="col-md-3">
				 <div class="list01 my-5">
					<p>About CarDekho</p>
					<ul class="navbar-nav my-2"></ul>
				 </div>
			  </div> 
			  <div class="col-md-3">
				 <div class="list02 my-5">
					<p>Connect With Us</p>
					<ul class="navbar-nav my-2"></ul>
				 </div>
			  </div>
			  <div class="col-md-3">
				 <div class="list03 my-5">
					<p>OTHERS</p>
					<ul class="navbar-nav my-2"></ul>
				 </div>
			  </div>
			  <div class="col-md-3">
				 <div class="list04 my-5">
					<p>EXPERIENCE CARDEKHO APP</p>
					<div class="col-md-6 d-flex gap-3 my-2">
		   ...
		   <div class="col-md-12  ">
			<div class"d-flex my-3">
			  ...
			  <div class="d-flex gap">
			  	<p>Connect:</p>
				<ul class="navbar-nav text-decoration-none my-5 p-10">
...
for(var i in list01){
	document.querySelector('.list01>ul').innerHTML+=`
	     <li class="my-1"><a class='text-decoration-none text-secondary' href="${list01[i].mlink}">${list01[i].mname}</a></li>
	`;
}
for(var i in list02){
	document.querySelector('.list02>ul').innerHTML+=`
	     <li class="my-1"><a class='text-decoration-none text-secondary' href="${list02[i].mlink}">${list02[i].mname}</a></li>
	`;
}
for(var i in list03){
	document.querySelector('.list03>ul').innerHTML+=`
	     <li class="my-1"><a class='text-decoration-none text-secondary' href="${list03[i].mlink}">${list03[i].mname}</a></li>
	`;
}
